...
def main():
    if len(sys.argv) < 3:
        print("Usage: python3 export_tokenizer.py <model_id_or_path> <output_dir>")
        sys.exit(1)
    ...
    tokenizer = LlmTokenizer.from_pretrained(model_id, model_type="qwen2") 
    
    print(f"Exporting to {output_dir}...")
    tokenizer.export(output_dir)
    print("Done!")
